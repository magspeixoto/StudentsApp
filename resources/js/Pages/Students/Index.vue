<script setup>
    ...
    let search = ref(page.props.search),
        pageNumber = ref(1),
        class_id = ref(page.props.class_id);
                ...
                <div class="px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex flex-col justify-start sm:flex-row mt-6">
                        ...
                        <select v-model="class_id"
                            class="fa fa-filter block rounded-lg border-0 py-2 ml-5 text-gray-900 ring-1 ring-inset ring-gray-200 placeholder:text-gray-400 sm:text-sm sm:leading-6">

                            <option value="" >
                                Filtered By Class
                            </option>
                            <option v-for="item in classes.data" :value="item.id" :key="item.id">{{item.name}}</option>
                        </select>
                    </div>
